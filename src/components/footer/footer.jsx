...
function Footer() {
  const onClickFacebook = () => {
    window.open("https://www.facebook.com/felipeblaksley", "_blank");
  };

  const onClickGithub = () => {
    window.open("https://github.com/Molli1992?tab=repositories", "_blank");
  };

  const onClickLinkedin = () => {
    window.open(
      "https://www.linkedin.com/in/felipe-blaksley-iraola-141b32236/",
      "_blank"
    );
  };

  const onClickInstagram = () => {
    window.open("https://www.instagram.com/felipeblaksley/", "_blank");
  };
